...
(function (w) {
    ...
    p.updateCSS = function () {
      // this.element.style[Propeller.cssPrefix + 'transform'] = 'rotate(' + this._angle + 'deg) ';
        // this.element.style['transform']='rotate(' + parseInt(this._angle) + 'deg 315deg 315deg)';
      this.element.setAttribute('transform','rotate(' + parseFloat(this._angle) + ' 315 315)');
    }
