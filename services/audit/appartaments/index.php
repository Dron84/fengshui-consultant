...
<body>
	...
	<?php if(isset($_GET['param'])){
		if($_GET['param']=='1'){
			echo ' style="background-image: url(/img/services/bg/auditApartamentTo50.jpg); background-position: `50%`;"';
		}
		if($_GET['param']=='2'){
			echo ' style="background-image: url(/img/services/bg/auditApartamentTo100.jpg); background-position: `50%`;"';
		}
		if($_GET['param']=='3'){
			echo ' style="background-image: url(/img/services/bg/auditApartamentBiger100.jpg); background-position: `50%`;"';
		}
	}
	?>>
		...
		<div class="jumbotron">
			<br><br><br><br>
			<h1 class="text-center ">Наши услуги по <br> Фен шуй аудит квартиры</h1>
			<br><br><br><br>
  		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-12">
				      ...
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				          <div class="orders-form">
								...
								<textarea class="form-control" rows="5" id="comment">Добрый день. Хотелось у вас заказать аудит квартиры!</textarea>
								</div>
				...
				<div>
					<h3>Как проходит Фен Шуй аудит квартиры:</h3>
					<ul>
