...
<body>
	<div class="container-fluid services" style="background-image: url('/img/services/bg/bacziConnection.jpg'); background-position: top;">
	...
	<div class="container">
		<div class="row">
			<h2 class="text-center">Консультация по Бацзы на совместимость</h2>
			<div class="col-xs-12">
				<div class="col-md-3 col-xs-12">
					<img src="/img/services/th/bacziConnection.jpg" class="img-thumbnail" alt="" style="width: 250px">
				</div>
				<div class="col-md-9 col-xs-12">
					...
					<br>Очень важно в процессе консультации понять по вашей карте и вашего избранного совместимы ли вы в принципе, а если нет но хочется что с этим делать и как все исправить, когда лучше выходить замуж/жениться и нужно ли это делать или лучше остаться в гражданских отношениях, когда лучше планировать детей, чтобы они были здоровы и счастливы, как выстраивать отношения дома).
				      ...
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				          <div class="orders-form">
								...
								<textarea class="form-control" rows="5" id="comment">Добрый день. Хотелось у вас заказать консультация по Бацзы на совместимость!</textarea>
								</div>
