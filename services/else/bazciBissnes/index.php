...
<body>
	<div class="container-fluid services" style="background-image: url('/img/services/bg/bacziBissnes.jpg'); background-position: top;">
	...
	<div class="container">
		<div class="row">
			<h2 class="text-center">Консультация Бацзы сфера дефтельности </h2>
			<div class="col-xs-12">
				<div class="col-md-3 col-xs-12">
					<img src="/img/services/th/bacziBissnes.jpg" class="img-thumbnail" alt="" style="width: 250px">
				</div>
				      ...
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				          <div class="orders-form">
								...
								<textarea class="form-control" rows="5" id="comment">Добрый день. Хотелось у вас заказать консультация по Бацзы партнеры по бизнесу!</textarea>
								</div>
