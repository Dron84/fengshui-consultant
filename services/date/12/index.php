...
<body>
	<div class="container-fluid services" style="background-image: url('/img/services/bg/date12.jpg'); background-position: top;">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="col-md-3 col-xs-12">
					<img src="/img/services/th/date12.jpg" class="img-thumbnail" alt="" style="width: 250px;">
				</div>
				<div class="col-md-9 col-xs-12">
					<p>Консультация по выбору даты на 12 месяцев</p>
				</div>
				      ...
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				          <div class="orders-form">
								...
								<textarea class="form-control" rows="5" id="comment">Добрый день. Хотелось у вас заказать консультацию по выбору даты на 12 месяцев</textarea>
								</div>
