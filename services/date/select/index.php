...
<body>
<div class="container-fluid services" style="background-image: url('/img/services/bg/dateSelect.jpg'); background-position: top;">
		<?php include(ROOT.'/nav.tpl'); ?>
		<div class="jumbotron">
			<br><br><br><br>
			<h1 class="text-center ">Наши услуги по <br>выбору конкретной даты</h1>
			<br><br><br><br>
  		</div>
		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="col-md-3 col-xs-12">
					<img src="/img/services/th/dateSelect.jpg" class="img-thumbnail" alt="" style="width: 250px;">
				</div>
				<div class="col-md-9 col-xs-12">
					<p>Консультация по выбору конкретной даты. Для использования этих дат в своей жизни. Такие как: день свадьбы, день лечения или день подписания важного договора.<br>
						<ul>
							<li>Посчитаем и подскажем как выбрать день свадьбы и укажем благополучное время</li>
							<li>Посчитаем и подскажем как выбрать день для подписания договора а также выбрать точное время!</li>
							<li>И так далее</li>
						</ul>
					</p>
				</div>
				      ...
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				          <div class="orders-form">
								...
								<textarea class="form-control" rows="5" id="comment">Добрый день. Хотелось у вас заказать консультация по выбору конкретной даты</textarea>
								</div>
